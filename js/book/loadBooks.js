    ...
    fetch(`/Sistema-de-Gestion-de-Biblioteca/api/books.php?page=${page}&limit=10`)
      ...
      .then((data) => {
        if (data.success) {
          ...
          const prevPage = page > 1 ? `<li class="page-item"><a class="page-link" href="#" onclick="loadBooks(${page - 1})">Previous</a></li>` : '';
          ...
          const nextPage = page < data.total_pages ? `<li class="page-item"><a class="page-link" href="#" onclick="loadBooks(${page + 1})">Next</a></li>` : '';
